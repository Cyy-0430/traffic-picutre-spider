...
cookies = [{'domain': '.vcg.com', 'expiry': 1747313407, 'httpOnly': False, 'name': 'ssxmod_itna2', 'path': '/',
...
async def main():
    params = [
        "honglvdeng",
        "jinzhitongxinglupai",
        "TINGCHERANGXINGBIAOZHI",
        "XUEXIAOSHEYOUERTONGGUOMALUJIAOTONGJINGGAOBIAOZHI",
        "LANSESANJIAOXINGRENXINGHENGDAOZHISHIPAI",
    ]
